...
<head>
    <title>Login to ProximaLab</title>
...
@if(session()->has('message'))
    <div class="flash flash-success">{{session()->get('message')}}</div>
@endif
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form class="form-horizontal" role="form" action="/login" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <button type="submit" class="btn btn-success btn-lg" style="cursor: pointer;">Login</button>
